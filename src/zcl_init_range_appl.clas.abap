CLASS zcl_init_range_appl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
METHOD if_oo_adt_classrun~main.
  ...
  nr_attribute-object = 'ZINFOB_APL'. " object name
  nr_attribute-domlen = 'ZD_APPLNUM'. " domain to be used eg char 10
  nr_attribute-percentage = 1.
  nr_attribute-devclass = 'ZNUMBERRANGE'.  "Class where number range actually gets created
  obj_text-langu = 'E'.
  obj_text-object = 'ZINFOB_APL'. "object name
