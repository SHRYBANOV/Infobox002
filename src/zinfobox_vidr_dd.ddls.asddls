...
define view entity ZINFOBOX_VIDR_DD
  as select from DDCDS_CUSTOMER_DOMAIN_VALUE( p_domain_name: 'ZD_VIDROBOT') as Value
                                                               ...
                                                               and _Text.language       = $session.system_language
{
  ...
  key Value.value_position                       as ValuePosition,
      ...
      @Semantics.text: true
      _Text( p_domain_name : 'ZD_VIDROBOT' ).text as Description
}
