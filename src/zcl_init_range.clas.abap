CLASS zcl_init_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_INIT_RANGE IMPLEMENTATION.
...
METHOD if_oo_adt_classrun~main.
  ...
  nr_attribute-object = 'ZINFOB_TAB'. " object name
  nr_attribute-domlen = 'ZD_TABEL'. " domain to be used eg char 10
  nr_attribute-percentage = 1.
  nr_attribute-devclass = 'ZNUMBERRANGE'.  "Class where number range actually gets created
  obj_text-langu = 'E'.
  obj_text-object = 'ZINFOB_TAB'. "object name
...
* st_INTERVAL-toyear
  st_interval-fromnumber  = '0000000001'. " starting number
  st_interval-tonumber    = '0000099999'. " ending number
